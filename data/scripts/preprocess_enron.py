...
def generate_mock_enron_data(num_samples=100) -> pd.DataFrame:
    ...
    subjects = [
        "Project Update", "Meeting Rescheduled", "Q3 Earnings Report",
        "Action Required: Compliance Training", "Lunch today?", 
        "Contract Review", "Welcome to the team", "Weekly Sync",
        "Follow up on our call", "Important: Office Policy Changes"
    ]
    ...
    senders = ["john.doe@enron.com", "jane.smith@enron.com", "admin@enron.com", "hr@enron.com"]
